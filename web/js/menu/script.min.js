window.Modernizr = function (a, b, c) {
  ...
  s.touch = function () {
    var c;
    return 'ontouchstart' in a || a.DocumentTouch && b instanceof DocumentTouch ? c = !0 : y(['@media (',
  ...
  s.generatedcontent = function () {
    var a;
    return y(['#modernizr:after{content:"',
    l,
    '";visibility:hidden}'].join(''), function (b) {
      a = b.offsetHeight >= 1
    }),
    a
  },
...
function (win) {
  ...
  if (win.respond = respond, respond.update = function () {
    ...
    translate = function (styles, href, media) {
      ...
      for (var i = 0; ql > i; i++) {
        ...
        eachq,
        eql;
        useMedia ? (fullq = media, rules.push(repUrls(styles)))  : (fullq = qs[i].match(/@media *([^\{]+)\{([\S\s]+?)$/) && RegExp.$1, rules.push(RegExp.$2 && repUrls(RegExp.$2))),
        eachq = fullq.split(','),
        eql = eachq.length;
        for (var j = 0; eql > j; j++)
        thisq = eachq[j],
    ...
    applyMedia = function (fromResize) {
      ...
      if (fromResize && lastCall && resizeThrottle > now - lastCall)
      return clearTimeout(resizeDefer),
      ...
      appendedEls.hasOwnProperty(j) && appendedEls[j] && appendedEls[j].parentNode === head && head.removeChild(appendedEls[j]);
...
var hljs = new function () {
  ...
  function b(p) {
    for (var o = p.firstChild; o; o = o.nextSibling) {
      if ('CODE' == o.nodeName)
      return o;
      if (3 != o.nodeType || !o.nodeValue.match(/\s+/))
      break
    }
  }
  function h(p, o) {
  ...
  function c(q) {
    ...
    return function p(r, s) {
      ...
      3 == t.nodeType ? s += t.nodeValue.length : 'BR' == t.nodeName ? s += 1 : 1 == t.nodeType && (o.push({
        event: 'start',
        offset: s,
        node: t
      }), s = p(t, s), o.push({
  ...
  function j(x, v, w) {
    ...
    for (var p = 0, y = '', r = [
      ...
      if (y += l(w.substr(p, u.offset - p)), p = u.offset, 'start' == u.event)
      y += s(u.node),
      r.push(u.node);
    ...
    function p(y, w) {
      ...
      if (!y.compiled) {
        ...
        if (y.k) {
          ...
          if (y.lR = o(y.l || hljs.IR, !0), 'string' == typeof y.k)
          z('keyword', y.k);
           else
          for (var x in y.k)
          y.k.hasOwnProperty(x) && z(x, y.k[x]);
          y.k = r
        }
        w && (y.bWK && (y.b = '\\b(' + s.join('|') + ')\\s'), y.bR = o(y.b ? y.b : '\\B|\\b'), y.e || y.eW || (y.e = '\\B|\\b'), y.e && (y.eR = o(y.e)), y.tE = y.e || '', y.eW && w.tE && (y.tE += (y.e ? '|' : '') + w.tE)),
        y.i && (y.iR = o(y.i)),
        void 0 === y.r && (y.r = 1),
        y.c || (y.c = [
        ]);
  ...
  function d(D, E) {
    ...
    function G() {
      ...
      for (var L = A.lR.exec(K); L; ) {
        ...
        var M = y(A, L);
        M ? (v += M[1], r += '<span class="' + M[0] + '">' + L[0] + '</span>')  : r += L[0],
        N = A.lR.lastIndex,
        L = A.lR.exec(K)
      }
      return r + K.substr(N)
    ...
    function z() {
      ...
      return A.r > 0 && (v += r.keyword_count, B += r.r),
      '<span class="' + r.language + '">' + r.value + '</span>'
    }
    function J() {
    ...
    function I(L, r) {
      ...
      L.rB ? (x += K, w = '')  : L.eB ? (x += l(r) + K, w = '')  : (x += K, w = r),
      A = Object.create(L, {
        parent: {
          value: A
        }
    ...
    try {
      for (var u, q, p = 0; ; ) {
        if (A.t.lastIndex = p, u = A.t.exec(E), !u)
        break;
  ...
  function g(s) {
    ...
    if (e.hasOwnProperty(p)) {
      ...
      r.keyword_count + r.r > o.keyword_count + o.r && (q = o, o = r)
    }
    return q.language && (o.second_best = q),
    o
  }
  function i(q, p, o) {
...
function (window, undefined) {
  ...
  function internalData(elem, name, data, pvt) {
    if (jQuery.acceptData(elem)) {
      ...
      return id || (isNode ? elem[internalKey] = id = core_deletedIds.pop() || jQuery.guid++ : id = internalKey),
      cache[id] || (cache[id] = {
      ...
      getByName ? (ret = thisCache[name], null == ret && (ret = thisCache[jQuery.camelCase(name)]))  : ret = thisCache,
      ret
    }
  }
    ...
    if (jQuery.acceptData(elem)) {
      ...
      if (cache[id]) {
        if (name && (thisCache = pvt ? cache[id] : cache[id].data)) {
          jQuery.isArray(name) ? name = name.concat(jQuery.map(name, jQuery.camelCase))  : name in thisCache ? name = [
            name
  ...
  function disableScript(elem) {
    ...
    return elem.type = (attr && attr.specified) + '/' + elem.type,
    elem
  }
  ...
  function showHide(elements, show) {
    for (var elem, values = [
    ], index = 0, length = elements.length; length > index; index++)
    elem = elements[index],
  ...
  function ajaxExtend(target, src) {
    ...
    for (key in src)
    src[key] !== undefined && ((flatOptions[key] ? target : deep || (deep = {
    })) [key] = src[key]);
  ...
  function Animation(elem, properties, options) {
    ...
    tick = function () {
      ...
      1 > percent && length ? remaining : (deferred.resolveWith(elem, [
        animation
      ]), !1)
    },
    ...
    return result;
    return createTweens(animation, props),
  ...
  jQuery.fn = jQuery.prototype = {
    ...
    eq: function (i) {
      var len = this.length,
      j = + i + (0 > i ? len : 0);
      return this.pushStack(j >= 0 && len > j ? [
        this[j]
      ] : [
      ])
    },
  ...
  jQuery.extend = jQuery.fn.extend = function () {
    ...
    }), length === i && (target = this, --i); length > i; i++)
    if (null != (options = arguments[i]))
    for (name in options)
    src = target[name],
    copy = options[name],
    target !== copy && (deep && copy && (jQuery.isPlainObject(copy) || (copyIsArray = jQuery.isArray(copy))) ? (copyIsArray ? (copyIsArray = !1, clone = src && jQuery.isArray(src) ? src : [
  ...
  jQuery.extend({
    ...
    ready: function (wait) {
      if (wait === !0 ? !--jQuery.readyWait : !jQuery.isReady) {
        ...
        jQuery.isReady = !0,
        wait !== !0 && --jQuery.readyWait > 0 || (readyList.resolveWith(document, [
          jQuery
    ...
    parseHTML: function (data, context, keepScripts) {
      ...
      ] : (parsed = jQuery.buildFragment([data], context, scripts), scripts && jQuery(scripts).remove(), jQuery.merge([], parsed.childNodes))
    },
  ...
  jQuery.Callbacks = function (options) {
    ...
    fire = function (data) {
      ...
      firing = !1,
      list && (stack ? stack.length && fire(stack.shift())  : memory ? list = [
      ] : self.disable())
    },
    self = {
      add: function () {
  ...
  jQuery.support = function () {
    ...
    return div.style.backgroundClip = 'content-box',
    ...
    data: function (key, value) {
      ...
      if (key === undefined) {
        if (this.length && (data = jQuery.data(elem), 1 === elem.nodeType && !jQuery._data(elem, 'parsedAttrs'))) {
          ...
          name = attrs[i].name,
          name.indexOf('data-') || (name = jQuery.camelCase(name.substring(5)), dataAttr(elem, name, data[name]));
  ...
  jQuery.fn.extend({
    ...
    toggleClass: function (value, stateVal) {
      ...
      return this.each(jQuery.isFunction(value) ? function (i) {
       ...
       : function () {
        if ('string' === type)
        for (var className, i = 0, self = jQuery(this), state = stateVal, classNames = value.match(core_rnotwhite) || []; className = classNames[i++]; )
  ...
  jQuery.extend({
    valHooks: {
      ...
      select: {
        get: function (elem) {
          for (var value, option, options = elem.options, index = elem.selectedIndex, one = 'select-one' === elem.type || 0 > index, values = one ? null : [
          ], max = one ? index + 1 : options.length, i = 0 > index ? max : one ? index : 0; max > i; i++)
  ...
  jQuery.support.hrefNormalized || (jQuery.each(['href',
  'src',
  'width',
  'height'], function (i, name) {
    jQuery.attrHooks[name] = jQuery.extend(jQuery.attrHooks[name], {
  ...
  jQuery.support.checkOn || jQuery.each(['radio',
  'checkbox'], function () {
  ...
  jQuery.event = {
    ...
    add: function (elem, types, handler, data, selector) {
      ...
      namespaces,
      origType,
      elemData = 3 !== elem.nodeType && 8 !== elem.nodeType && jQuery._data(elem);
      if (elemData) {
        ...
        }, eventHandle.elem = elem), types = (types || '').match(core_rnotwhite) || [''], t = types.length; t--; )
    ...
    remove: function (elem, types, handler, selector, mappedTypes) {
      ...
      if (elemData && (events = elemData.events)) {
        ...
        if (tmp = rtypenamespace.exec(types[t]) || [], type = origType = tmp[1], namespaces = (tmp[2] || '').split('.').sort(), type) {
          ...
          }, type = (selector ? special.delegateType : special.bindType) || type, handlers = events[type] || [], tmp = tmp[2] && new RegExp('(^|\\.)' + namespaces.join('\\.(?:.*\\.|)') + '(\\.|$)'), origCount = j = handlers.length; j--; )
    ...
    trigger: function (event, data, elem, onlyHandlers) {
      ...
      if (cur = tmp = elem = elem || document, 3 !== elem.nodeType && 8 !== elem.nodeType && !rfocusMorph.test(type + jQuery.event.triggered) && (type.indexOf('.') >= 0 && (namespaces = type.split('.'), type = namespaces.shift(), namespaces.sort()), ontype = type.indexOf(':') < 0 && 'on' + type, event = event[jQuery.expando] ? event : new jQuery.Event(type, 'object' == typeof event && event), event.isTrigger = !0, event.namespace = namespaces.join('.'), event.namespace_re = event.namespace ? new RegExp('(^|\\.)' + namespaces.join('\\.(?:.*\\.|)') + '(\\.|$)')  : null, event.result = undefined, event.target || (event.target = elem), data = null == data ? [
        event
    ...
    dispatch: function (event) {
      ...
      if (args[0] = event, event.delegateTarget = this, !special.preDispatch || special.preDispatch.call(this, event) !== !1) {
        ...
        for (event.currentTarget = matched.elem, j = 0; (handleObj = matched.handlers[j++]) && !event.isImmediatePropagationStopped(); ) (!event.namespace_re || event.namespace_re.test(handleObj.namespace)) && (event.handleObj = handleObj, event.data = handleObj.data, ret = ((jQuery.event.special[handleObj.origType] || {
        }).handle || handleObj.handler).apply(matched.elem, args), ret !== undefined && (event.result = ret) === !1 && (event.preventDefault(), event.stopPropagation()));
    ...
    handlers: function (event, handlers) {
      ...
      if (cur.disabled !== !0 || 'click' !== event.type) {
        ...
        matches[sel] === undefined && (matches[sel] = handleObj.needsContext ? jQuery(sel, this).index(cur) >= 0 : jQuery.find(sel, this, null, [
          cur
        ]).length),
    ...
    fix: function (event) {
      ...
      for (event = new jQuery.Event(originalEvent), i = copy.length; i--; )
      prop = copy[i],
  ...
  jQuery.Event = function (src, props) {
    return this instanceof jQuery.Event ? (src && src.type ? (this.originalEvent = src, this.type = src.type, this.isDefaultPrevented = src.defaultPrevented || src.returnValue === !1 || src.defaultPrevented && src.defaultPrevented() ? returnTrue : returnFalse)  : this.type = src, props && jQuery.extend(this, props), this.timeStamp = src && src.timeStamp || jQuery.now(), void (this[jQuery.expando] = !0))  : new jQuery.Event(src, props)
  },
  ...
  function (window, undefined) {
    ...
    function Sizzle(selector, context, results, seed) {
      ...
      if (!documentIsXML && !seed) {
        ...
        if (m = match[1]) {
          ...
          if (match[2])
          return push.apply(results, slice.call(context.getElementsByTagName(selector), 0)),
          results;
          if ((m = match[3]) && support.getByClassName && context.getElementsByClassName)
          return push.apply(results, slice.call(context.getElementsByClassName(m), 0)),
          results
        }
      ...
      return combinator.first ? function (elem, context, xml) {
       ...
       : function (elem, context, xml) {
        ...
        if (outerCache = elem[expando] || (elem[expando] = {
          ...
          dirkey
        ], cache[1] = matcher(elem, context, xml) || cachedruns, cache[1] === !0)
        return !0
      }
    }
    ...
    function condense(unmatched, map, filter, context, xml) {
      for (var elem, newUnmatched = [
      ], i = 0, len = unmatched.length, mapped = null != map; len > i; i++) (elem = unmatched[i]) && (!filter || filter(elem, context, xml)) && (newUnmatched.push(elem), mapped && map.push(i));
      return newUnmatched
    }
    function setMatcher(preFilter, selector, matcher, postFilter, postFinder, postSelector) {
      ...
      markFunction(function (seed, results, context, xml) {
        ...
        for (temp = condense(matcherOut, postMap), postFilter(temp, [
        ], context, xml), i = temp.length; i--; ) (elem = temp[i]) && (matcherOut[postMap[i]] = !(matcherIn[postMap[i]] = elem));
        if (seed) {
          if (postFinder || preFilter) {
            if (postFinder) {
              for (temp = [
              ], i = matcherOut.length; i--; ) (elem = matcherOut[i]) && temp.push(matcherIn[i] = elem);
    ...
    function select(selector, context, results, seed) {
      ...
      if (!seed && 1 === match.length) {
        ...
        if ((find = Expr.find[type]) && (seed = find(token.matches[0].replace(runescape, funescape), rsibling.test(tokens[0].type) && context.parentNode || context))) {
          ...
          return push.apply(results, slice.call(seed, 0)),
          results;
          break
        }
      }
    ...
    setDocument = Sizzle.setDocument = function (node) {
      ...
      return doc !== document && 9 === doc.nodeType && doc.documentElement ? (document = doc, docElem = doc.documentElement, documentIsXML = isXML(doc), support.tagNameNoComments = assert(function (div) {
        ...
        div.getElementsByClassName && div.getElementsByClassName('e').length ? (div.lastChild.className = 'e', 2 === div.getElementsByClassName('e').length)  : !1
      }), support.getByName = assert(function (div) {
        div.id = expando + 0,
        div.innerHTML = '<a name=\'' + expando + '\'></a><div name=\'' + expando + '\'></div>',
        docElem.insertBefore(div, docElem.firstChild);
        var pass = doc.getElementsByName && doc.getElementsByName(expando).length === 2 + doc.getElementsByName(expando + 0).length;
        return support.getIdNotName = !doc.getElementById(expando),
       ...
       : function (a, b) {
        ...
        0,
        0
      ].sort(sortOrder), support.detectDuplicates = hasDuplicate, document)  : document
    },
    Sizzle.matches = function (expr, elements) {
      return Sizzle(expr, null, null, elements)
    },
    Sizzle.matchesSelector = function (elem, expr) {
      if ((elem.ownerDocument || elem) !== document && setDocument(elem), expr = expr.replace(rattributeQuotes, '=\'$1\']'), !(!support.matchesSelector || documentIsXML || rbuggyMatches && rbuggyMatches.test(expr) || rbuggyQSA.test(expr)))
      try {
    ...
    Sizzle.attr = function (elem, name) {
      var val;
      return (elem.ownerDocument || elem) !== document && setDocument(elem),
           ...
           : function (elem, context, xml) {
            ...
            if (parent) {
              ...
              if (start = [
                ...
                }), cache = outerCache[type] || [], nodeIndex = cache[0] === dirruns && cache[1], diff = cache[0] === dirruns && cache[2], node = nodeIndex && parent.childNodes[nodeIndex]; node = ++nodeIndex && node && node[dir] || (diff = nodeIndex = 0) || start.pop(); )
              ...
              for (; (node = ++nodeIndex && node && node[dir] || (diff = nodeIndex = 0) || start.pop()) && ((ofType ? node.nodeName.toLowerCase() !== name : 1 !== node.nodeType) || !++diff || (useCache && ((node[expando] || (node[expando] = {
              })) [type] = [
                dirruns,
                diff
              ]), node !== elem)); )
      ...
      pseudos: {
        not: markFunction(function (selector) {
          ...
          return matcher[expando] ? markFunction(function (seed, matches, context, xml) {
            for (var elem, unmatched = matcher(seed, null, xml, [
            ]), i = seed.length; i--; ) (elem = unmatched[i]) && (seed[i] = !(matches[i] = elem))
          })  : function (elem, context, xml) {
            return input[0] = elem,
  ...
  jQuery.fn.extend({
    find: function (selector) {
      ...
      return ret = this.pushStack(jQuery.unique(ret)),
    ...
    closest: function (selectors, context) {
      for (var cur, i = 0, l = this.length, ret = [
      ], pos = rneedsContext.test(selectors) || 'string' != typeof selectors ? jQuery(selectors, context || this.context)  : 0; l > i; i++)
  ...
  jQuery.each({
    ...
    jQuery.fn[name] = function (until, selector) {
      ...
      return runtil.test(name) || (selector = until),
  ...
  jQuery.extend({
    filter: function (expr, elems, not) {
      ...
      1 === elems.length ? jQuery.find.matchesSelector(elems[0], expr) ? [
        elems[0]
      ] : [
    ...
    dir: function (elem, dir, until) {
      for (var matched = [
      ], cur = elem[dir]; cur && 9 !== cur.nodeType && (until === undefined || 1 !== cur.nodeType || !jQuery(cur).is(until)); )
  ...
  jQuery.fn.extend({
    ...
    domManip: function (args, table, callback) {
      ...
      if (isFunction || !(1 >= l || 'string' != typeof value || jQuery.support.checkClone) && rchecked.test(value))
      ...
      if (l && (fragment = jQuery.buildFragment(args, this[0].ownerDocument, !1, this), first = fragment.firstChild, 1 === fragment.childNodes.length && (fragment = first), first)) {
        for (table = table && jQuery.nodeName(first, 'tr'), scripts = jQuery.map(getAll(fragment, 'script'), disableScript), hasScripts = scripts.length; l > i; i++)
        node = fragment,
  ...
  jQuery.each({
    ...
    jQuery.fn[name] = function (selector) {
      for (var elems, i = 0, ret = [
      ], insert = jQuery(selector), last = insert.length - 1; last >= i; i++)
  ...
  jQuery.extend({
    ...
    buildFragment: function (elems, context, scripts, selection) {
      for (var contains, elem, tag, tmp, wrap, tbody, j, l = elems.length, safe = createSafeFragment(context), nodes = [
      ], i = 0; l > i; i++)
      ...
      jQuery.merge(nodes, elem.nodeType ? [
        ...
        '']) [1].toLowerCase(), wrap = wrapMap[tag] || wrapMap._default, tmp.innerHTML = wrap[1] + elem.replace(rxhtmlTag, '<$1></$2>') + wrap[2], j = wrap[0]; j--; )
        tmp = tmp.lastChild;
  ...
  jQuery.extend({
    ...
    style: function (elem, name, value, extra) {
      if (elem && 3 !== elem.nodeType && 8 !== elem.nodeType && elem.style) {
        ...
        if (type = typeof value, 'string' === type && (ret = rrelNum.exec(value)) && (value = (ret[1] + 1) * ret[2] + parseFloat(jQuery.css(elem, name)), type = 'number'), !(null == value || 'number' === type && isNaN(value) || ('number' !== type || jQuery.cssNumber[origName] || (value += 'px'), jQuery.support.clearCloneStyle || '' !== value || 0 !== name.indexOf('background') || (style[name] = 'inherit'), hooks && 'set' in hooks && (value = hooks.set(elem, value, extra)) === undefined)))
        try {
          style[name] = value
        } catch (e) {
        }
    ...
    css: function (elem, name, extra, styles) {
      ...
      extra ? (num = parseFloat(val), extra === !0 || jQuery.isNumeric(num) ? num || 0 : val)  : val
    },
  ...
  jQuery(function () {
    ...
    !jQuery.support.pixelPosition && jQuery.fn.position && jQuery.each(['top',
  ...
  jQuery.fn.extend({
    ...
    finish: function (type) {
      ...
      this.each(function () {
        ...
        ]), hooks && hooks.cur && hooks.cur.finish && hooks.cur.finish.call(this), index = timers.length; index--; )
  ...
  jQuery.fn.offset = function (options) {
    ...
    jQuery.contains(docElem, elem) ? ('undefined' != typeof elem.getBoundingClientRect && (box = elem.getBoundingClientRect()), win = getWindow(doc), {
  ...
  jQuery.offset = {
    setOffset: function (elem, options, i) {
      ...
      calculatePosition = ('absolute' === position || 'fixed' === position) && jQuery.inArray('auto', [
        curCSSTop,
        curCSSLeft
      ]) > - 1,
      props = {
  ...
  jQuery.fn.extend({
    ...
    offsetParent: function () {
      return this.map(function () {
        for (var offsetParent = this.offsetParent || document.documentElement; offsetParent && !jQuery.nodeName(offsetParent, 'html') && 'static' === jQuery.css(offsetParent, 'position'); )
  ...
  $.jPanelMenu = function (options) {
    ...
    var jP = {
      ...
      setPositionUnits: function () {
        for (var foundUnit = !1, allowedUnits = [
          '%',
          'px',
          'em'
        ], unitID = 0; unitID < allowedUnits.length; unitID++) {
      ...
      computePositionStyle: function (open, string) {
        ...
        string ? (property = '', property = jP.options.direction + ': ' + position + ';')  : property[jP.options.direction] = position;
        return property
      },
      ...
      setjPanelMenuStyles: function () {
        ...
        backgroundGenerator = function (element) {
          ...
          return $.each(['background-color',
          'background-image',
          'background-position',
          'background-repeat',
          'background-attachment',
          'background-size',
          'background-clip'], function (i, value) {
            '' !== element.css(value) && bgs.push(value + ':' + element.css(value))
          }),
          bgs.join(';')
        };
        'transparent' !== bodyBG && 'rgba(0, 0, 0, 0)' !== bodyBG ? bg = backgroundGenerator($('body'))  : 'transparent' !== htmlBG && 'rgba(0, 0, 0, 0)' !== htmlBG && (bg = backgroundGenerator($('html'))),
      ...
      openMenu: function (animated) {
        ('undefined' == typeof animated || null == animated) && (animated = jP.options.animated),
        jP.clearTimeouts(),
        jP.options.before(),
        ...
        if (animationChecks.transitions || animationChecks.none) {
          animationChecks.none && jP.disableTransitions(),
          animationChecks.transitions && jP.enableTransitions(jP.options.openDuration, jP.options.openEasing);
      ...
      closeMenu: function (animated) {
        ...
        if (animationChecks.transitions || animationChecks.none) {
          animationChecks.none && jP.disableTransitions(),
          animationChecks.transitions && jP.enableTransitions(jP.options.closeDuration, jP.options.closeEasing);
      ...
      initiateContentClickListeners: function () {
        return jP.options.closeOnContentClick ? void $(document).on('click touchend', jP.panel, function (e) {
          jP.menuIsOpen() && jP.closeMenu(jP.options.animated),
          e.preventDefault()
        })  : !1
      },
      ...
      initiateKeyboardListeners: function () {
        ...
        $(document).on('keydown', function (e) {
          ...
          if (e.which == jP.options.keyboardShortcuts[mapping].code) {
            ...
            key.open && key.close ? jP.triggerMenu(jP.options.animated)  : !key.open || key.close || jP.menuIsOpen() ? !key.open && key.close && jP.menuIsOpen() && jP.closeMenu(jP.options.animated)  : jP.openMenu(jP.options.animated),
            e.preventDefault()
          }
        })
      },
      ...
      init: function () {
        ...
        '[object Array]' === Object.prototype.toString.call(jP.options.keyboardShortcuts) && jP.initiateKeyboardListeners(),
      ...
      destroy: function () {
        ...
        '[object Array]' === Object.prototype.toString.call(jP.options.keyboardShortcuts) && jP.destroyKeyboardListeners(),
        jP.resetMarkup();
        var childrenStyles = {
        };
    ...
    return {
      ...
      setPosition: function (position) {
        ('undefined' == typeof position || null == position) && (position = jP.options.openPosition),
...
window.console && console.log || !function () {
  for (var noop = function () {
    ...
    'trace',
    'warn'
  ], length = methods.length, console = window.console = {
  }; length--; )
